...
export const EditLecture = () => {
    ...
    // API Hooks
    const { ApiData: AddCourseData, patch: GetAddCourse } = usePatch(`lectures/${id}`);
    const { ApiData: CategoriesData, get: GetCategories } = useGet(`category`);
    const { ApiData: sepicficLecture, get: GetSpecificLecture } = useGet(`lectures/${id}`);
    ...
    useEffect(() => {
        if (sepicficLecture) {
            setFormData({
                ...
                lectureLength: sepicficLecture?.lectureLength
                        ...
                        <form onSubmit={handleSubmit}>
                            <div className="row">
                                ...
                                <div className="col-md-12">
                                    <CustomButton
                                        text={status.includes('Uploading') ? 'Uploading...' : 'Update'}
